...
def test_store_events(mock_kafka_consumer, mock_s3_client, mock_uuid, mock_datetime):
    ...
    for i, expected_path in enumerate(expected_paths):
        ...
        assert (
            f"{settings.storage_file_prefix}_20230101120000_12345678123456781234567812345678.parquet"
            in s3_key
        )
...
def test_store_events_invalid_message(
    mock_kafka_consumer, mock_s3_client, mock_uuid, mock_datetime
):
    """
